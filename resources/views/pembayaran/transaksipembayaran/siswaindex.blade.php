...
<section class="content card" style="padding: 10px 10px 10px 10px ">
  <h4><i class="nav-icon fas fa-warehouse my-1 btn-sm-1"></i> Absensi</h4>
  <hr>
  @if(session('sukses'))
  ...
  @endif
  @foreach($tagihan_siswa as $item_ins)
  <div class="row">
      <div class="col-md-12">
              ...
              <div class="row">
                  <div class="col-9">
                      ...
                      <ul class="ml-4 mb-0 fa-ul text-black">
                          ...
                          <li><span class="fa-li"><i class="nav-icon fas fa-warehouse my-1 btn-sm-1"></i></span>
                              <h4>Kelas
    ...
    @if ($item_ins->absen === null)
        <form action="{{ route('updateStatus', ['id' => $item_ins->id]) }}" method="POST">
            @csrf
            <button type="submit" class="btn btn-success" onclick="return confirm('Anda yakin ingin mengubah status absen menjadi Masuk?')">
                Masuk
            </button>
        </form>
    @else
