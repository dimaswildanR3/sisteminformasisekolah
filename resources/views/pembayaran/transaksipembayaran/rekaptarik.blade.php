...
<section class="content card" style="padding: 10px 10px 10px 10px ">
    <div class="box">
        ...
        <div class="row">
            <div class="col">
                <h4><i class="nav-icon fas fa-user my-1 btn-sm-1"></i>Rekap Pembayaran Insidental</h4>
                <hr>
            </div>
        </div>
        <div>
                ...
                <table class="table table-hover table-head-fixed" id='tabelSuratmasuk'>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
            <a href="{{ route('kuitansi.prints', ['id' => $pengguna->id]) }}" target="_blank" class="btn btn-primary btn-sm my-1 mr-sm-1"><i class="fas fa-print"></i> Cetak</a>
