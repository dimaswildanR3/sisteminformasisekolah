                        ...
                        <div class="card card-primary card-outline">
                            <div class="card-body box-profile">
                                {{-- <div class="text-center">
                                    <img class="profile-user-img img-fluid img-circle" src={{$pesdik->image}} alt="User profile picture" style="max-height: 100px;max-width:100px">
                                </div> --}}
                                <h3 class="profile-username text-center"><b>{{$pesdik->nama}}</b></h3>
                                <p class="text-muted text-center">{{$pesdik->kelas}}</p>
                                <p class="text-muted text-center">{{$pesdik->tapel}}</p>
                                <ul class="list-group list-group-unbordered mb-3">
                                    ...
                                    <li class="list-group-item">
                                        <b>Bank PIP</b> <a class="float-right">{{$pesdik->bank_untuk_pip}}</a>
                                    </li>
                                    <li class="list-group-item">
                                        <b>Nama Ayah Kandung</b> <a class="float-right">{{$pesdik->data_ayah_kandung?? "-"}}</a>
                                        
                                    </li>
                                    <li class="list-group-item">
                                        <b>Nama Ibu Kandung</b> <a class="float-right">{{$pesdik->data_ibu_kandung ?? "-"}}</a>
                                    </li>
                                    <li class="list-group-item">
                                        <b>Nama Wali</b> <a class="float-right">{{$pesdik->data_wali_murid?? "-"}}</a>
                                    </li>
                                    <li class="list-group-item">
                                        <b>Nomor Kontak</b> <a class="float-right">{{$pesdik->kontak}}</a>
                                    </li>
                                </ul>
                            </div>
                            <!-- /.card-body -->
