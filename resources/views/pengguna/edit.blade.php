        ...
        <form action="{{ route('pengguna.update', $data_pengguna->id) }}" method="POST">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input name="email" type="email" class="form-control" id="email" placeholder="USername" value="{{$data_pengguna->email}}" disabled>
                </div>
                <div class="col-md-6">
                    ...
                    <select name="role" id="role" class="form-control" disabled>
                        ...
                        <option value="PetugasPerpus" @if ($data_pengguna->role == 'PetugasPerpus') selected @endif>PetugasPerpus</option>
                        ...
                        <option value="petugastu" @if ($data_pengguna->role == 'petugastu') selected @endif>Tata Usaha</option>
                        <option value="walikelas" @if ($data_pengguna->role == 'walikelas') selected @endif>Wali Kelas</option>
                        <option value="bk" @if ($data_pengguna->role == 'bk') selected @endif>BK</option>
                    </select>
                </div>
            </div>
            <hr>
