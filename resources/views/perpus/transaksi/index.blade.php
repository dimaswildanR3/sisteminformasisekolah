...
<section class="content card" style="padding: 10px 10px 20px 20px  ">
    <div class="box">
        ...
        <div class="row">
            <div class="col">
                <h4><i class="nav-icon fas fa-child my-0 btn-sm-1"></i> Data Peminjam Buku Perpustakaan</h3>
                <hr>
            </div>
        </div>
        <div>
            <div class="col">
                ...
                <a class="btn btn-primary btn-sm my-1 mr-sm-1" href="bukukembali" role="button"style="float: right;"><i class="fas fa-folder"></i>  Data Kembali</a>
                {{-- <button type="submit" class="btn btn-primary btn-sm my-1 mr-sm-1 float-right"><i class="fas fa-print"></i> Cetak</button>             --}}
            <a class="btn btn-primary btn-sm my-1 mr-sm-1 float-right" href="/perpus/transaksi/export_excel" role="button"><i class="fas fa-file-excel"></i> Download Excel</a>
