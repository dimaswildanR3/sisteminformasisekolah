...
<section class="content card" style="padding: 10px 10px 10px 10px ">
    <div class="box">
        ...
        <form action="/tabungan/tarik/{{$tarik->id}}/update" method="POST">
            <h4><i class="nav-icon fas fa-money-bill-alt my-1 btn-sm-1"></i> Edit Data Iuran Insidental Tunai</h3>
            <hr>
            {{csrf_field()}}
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input value="{{$tarik->jumlah}}" name="jumlah" type="number" class="form-control" id="jumlah" placeholder="Jumlah">
