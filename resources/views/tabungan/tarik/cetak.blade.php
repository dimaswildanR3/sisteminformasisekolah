    ...
    <div class="row">
      <div class="col-12">
        <div class="callout callout-success alert alert-success alert-dismissible fade show">
          ...
          - Data Iuran Insidental telah berhasil disimpan ! <br>
          - Halaman ini dapat dicetak sebagai bukti transaksi, Silahkan klik tombol CETAK yang berada dibawah halaman ! <br>
          - Klik tombol KEMBALI setelah selesai mecetak bukti Iuran Insidental !
        ...
        <div class="invoice p-3 mb-3">
          ...
          <div class="row">
            <div class="col-12">
              <h4>
                <img src="/logo.png" alt="Logo Instansi" class="rounded" width="75"></i> Tanda Bukti Iuran Insidental
            ...
            <div class="col-6">
              ...
              <div class="table-responsive">
                <table class="table">
                  ...
                  <tr>
                    <th>Sisa Saldo</th>
                    <td><b>@currency($total_tarik),00</b></td>
                  </tr>
                </table>
              </div>
            </div>
