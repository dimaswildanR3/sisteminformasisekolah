...
<section class="content card" style="padding: 10px 10px 10px 10px ">
    <div class="box">
        ...
        <form action="/tabungan/setor/{{$setor->id}}/update" method="POST">
            <h4><i class="nav-icon fas fa-credit-card my-1 btn-sm-1"></i> Edit Data PERSONAL</h4>
            <hr>
            {{csrf_field()}}
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input value="{{$setor->jumlah}}" name="jumlah" type="number" class="form-control" id="jumlah" placeholder="Jumlah" >
