...
<head>
  ...
  <title>Tanda Bukti Iuran Personal No_{{$setor->pesdik->nisn}}-0{{$setor->id}}</title>
          ...
          <div class="col-12">
            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row">
                <div class="col-12">
                  <h4>
                    <img src="/logo.png" alt="Logo Instansi" class="rounded" width="50"></i> Tanda Bukti Iuran Personal
              ...
              <div class="row">
                ...
                <div class="col-6">
                  ...
                  <p class="text-muted well well-sm shadow-none" style="margin-top: 10px;">
                    - Mohon disimpan sebagai bukti Iuran Personal yang sah <br>
                ...
                <!-- /.col -->
                <div class="col-6">
                  <p class="lead">Rekap Iuran Personal Siswa :</p>
                  <?php
                  $id = $setor->pesdik->id;
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      <tr>
                        <th style="width:50%">Total Iuran Personal</th>
