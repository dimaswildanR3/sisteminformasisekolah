        ...
        <form action="/keuangan/pengeluaran/{{$pengeluaran->id}}/update" method="POST">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input value="{{$pengeluaran->kategori_id}}" name="kategori_id" type="text" class="form-control" id="kategori_id" placeholder="Kategori" required oninvalid="this.setCustomValidity('Isian ini tidak boleh kosong !')" oninput="setCustomValidity('')">
