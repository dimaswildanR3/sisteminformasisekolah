...
<body>
    <div class="kotak_login">
        ...
        @endif
        <img src="/essos.jpeg" alt="Logo" class="logo"style="width:190px;height:180px;margin-bottom:-30px;">
        <br>
        <h2 class="font-weight-bold text-center">ESSOS</h2>
        <h6 class="font-weight-bold text-center">Esempe Satu Srono Online System</h6>
