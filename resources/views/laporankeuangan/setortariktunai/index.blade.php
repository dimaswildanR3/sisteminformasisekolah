...
<section class="content card" style="padding: 10px 10px 20px 20px  ">
    <div class="box">
        ...
        <div class="row">
            <div class="col">
                <h4><i class="nav-icon fas fa-credit-card my-1 btn-sm-1"></i> Laporan Iuran</h4>
                <hr>
            </div>
        </div>
        <div class="row">
                            ...
                            <!-- <div class="col-md-3">
                                <form action="/laporankeuangan/setortariktunai/filterByKelas" method="POST">
                                    ...
                                    <select name="filterKelas" id="filterKelas" class="form-control select2bs4 my-1 mr-sm-1" onchange="this.form.submit();">
                                       ...
                                       @foreach($daftar_nama as $list_nama)
                                        <option value="{{ $list_nama->pesdik_id }}">{{$list_nama->pesdik->kelas}}</option>
                                        @endforeach
                                    </select>
                                </form>
                            </div> -->
        ...
        <div class="card">
            <div class="card-header bg-light">
                <ul class="nav nav-pills">
                    <li class="nav-item"><a class="nav-link active btn-sm" href="#setor" data-toggle="tab"><i class="fas fa-credit-card"></i> Laporan Iuran personal</a></li>
                    <li class="nav-item"><a class="nav-link btn-sm" href="#pesdik" data-toggle="tab"><i class="fas fa-credit-card"></i> Laporan Iuran Insidental</a></li>
                </ul>
            </div>
            <div class="card-body">
