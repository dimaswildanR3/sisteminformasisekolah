...
class DashboardController extends Controller
{
    ...
    public function siswadashboard(User $pengguna, $id)
    {
        ...
        $data_admin = \App\User::where('role', "admin")->get();
        $data_petugas = \App\Tendik::all();
        $data_pengumuman = \App\pengumuman_siswa::where('users_id',$id_pesdik_login->id)->orderByRaw('created_at DESC')->get();
        // dd($data_pengumuman);   
        return view('siswadashboard', compact('data_admin', 'data_login', 'data_pengumuman', 'data_petugas', 'id_pesdik_login'));
    }
}
